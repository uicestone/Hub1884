...
<section class="section swatch-blue section-text-shadow section-inner-shadow">
	...
	<div class="row">
		<div class="col-md-9">
		<header class="text-center element-short-top element-short-bottom not-condensed os-animation" data-os-animation="fadeIn" data-os-animation-delay=".4s">
			<h3 class="big light bordered-normal">
			Like what you see? There is loads more in this theme!
			</h3>
		</header>
		</div>
		<div class="col-md-3">
		<a href="http://themeforest.net/item/omega-multi-purpose-bootstrap-html-template/8591628" class="btn btn-primary btn-lg element-short-top element-short-bottom os-animation" target="_self" data-os-animation="fadeInRight" data-os-animation-delay="0.3s">
			buy it now
		</a>
		</div>
	</div>
