...
<section id="two" class="section swatch-white">
	...
	<div class="row">
		...
		<div class="col-md-6">
			<p class="lead text-right element-tall-top element-short-bottom">An online shop evokes the physical analogy of buying <strong>products</strong> or services at a bricks-and-mortar retailer or shopping center; the process is called business-to-consumer (B2C) online shopping. <strong>Omega</strong> is
			the best theme to enhance your online presence.</p>
		</div>
		<div class="col-md-6 text-center">
			<div class="element-short-top element-normal-bottom os-animation" data-os-animation="fadeInRight" data-os-animation-delay="0s">
			<canvas id="purple-dougnut" height="333" width="400"></canvas>
			</div>
		</div>
		</div>
	</div>
