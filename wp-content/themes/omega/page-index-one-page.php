...
<section id="home" class="section swatch-black">
	...
	<div class="row">
		...
		<header class="element-short-top element-short-bottom os-animation condensed">
...
<section id="portfolio" class="section swatch-black">
	...
	<div class="row">
		...
		<header class="text-center element-normal-top element-medium-bottom os-animation condensed" data-os-animation="fadeIn" data-os-animation-delay="0s">
			...
			<p class="lead">
			Omega is the perfect theme to showcase your work. Loads of portfolio options and styles to cover all needs.
			</p>
		</header>
...
<section id="features" class="section swatch-white">
	<div class="container">
	<div class="row">
		<div class="col-md-12">
		<header class="text-center element-tall-top element-no-bottom os-animation condensed" data-os-animation="fadeIn" data-os-animation-delay="0s">
...
<section id="two" class="section swatch-white">
	...
	<div class="row">
		...
		<a href="http://themeforest.net/item/omega-multi-purpose-bootstrap-html-template/8591628" class="btn btn-default btn-lg  btn-icon-right  element-short-top element-tall-bottom os-animation" target="_self" data-os-animation="fadeIn" data-os-animation-delay="0s">
			Get it now!
			<span>
			<i class="fa fa-leaf" data-animation="fadeIn"></i>
			</span>
		</a>
		</div>
	</div>
