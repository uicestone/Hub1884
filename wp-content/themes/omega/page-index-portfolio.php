...
<section id="six" class="section swatch-black section-text-shadow section-inner-shadow">
	...
	<div class="row">
		...
		<img src="<?=get_stylesheet_directory_uri()?>/assets/images/uploads/vintage.png" alt="omega" data-start="opacity:1" data-center="opacity:1" data-100-top-bottom="opacity:0">
		</div>
	</div>
	</div>
</section>
	...
	<div class="row">
		...
		<div class="col-md-6">
			...
			<span class="figure-image">
				<img src="<?=get_stylesheet_directory_uri()?>/assets/images/people/image-16-normal.jpg" class="normalwidth" alt="About Me Pic">
			</span>
			</div>
		</div>
		<div class="col-md-6">
