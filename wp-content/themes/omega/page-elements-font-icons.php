...
<section id="two" class="section swatch-white">
	...
	<div class="row">
		...
		<div class="wpb_raw_code wpb_content_element wpb_raw_html">
			...
			<div class="col-md-4 col-sm-6 element-normal-bottom">
				<h3><i class="fa fa-flag"></i> <strong>One Font, 370 Icons</strong></h3>
				In a single collection, Font Awesome is a pictographic language of web-related actions.
			</div>
			<div class="col-md-4 col-sm-6 element-normal-bottom">
				<h3><i class="fa fa-ban"></i> <strong>No JavaScript Required</strong></h3>
				Fewer compatibility concerns because Font Awesome doesn't require JavaScript.
			</div>
			<div class="col-md-4 col-sm-6 element-normal-bottom">
				<h3><i class="fa fa-fullscreen"></i> <strong>Infinite Scalability</strong></h3>
				Scalable vector graphics means every icon looks awesome at any size.
			</div>
			<div class="col-md-4 col-sm-6 element-normal-bottom">
				<h3><i class="fa fa-microphone"></i> <strong>Free, as in Speech</strong></h3>
				Font Awesome is completely free for commercial use. Check out the <a href="./license/">license</a>.
			</div>
			<div class="col-md-4 col-sm-6 element-normal-bottom">
				<h3><i class="fa fa-pencil"></i> <strong>CSS Control</strong></h3>
				Easily style icon color, size, shadow, and anything that's possible with CSS.
			</div>
			<div class="col-md-4 col-sm-6 element-normal-bottom">
				<h3><i class="fa fa-eye"></i> <strong>Perfect on Retina Displays</strong></h3>
				Font Awesome icons are vectors, which mean they're gorgeous on high-resolution displays.
			</div>
			<div class="col-md-4 col-sm-6 element-normal-bottom">
				<h3><i class="fa fa-thumbs-o-up"></i> <strong>Made for Bootstrap</strong></h3>
				Designed from scratch to be fully compatible with <a href="http://getbootstrap.com">Bootstrap 3.0.0</a>.
			</div>
			<div class="col-md-4 col-sm-6 element-normal-bottom">
				<h3><i class="fa fa-desktop"></i> <strong>Desktop Friendly</strong></h3>
				To use on the desktop or for a complete set of vectors, check out the <a href="./cheatsheet/">cheatsheet</a>.
			</div>
			<div class="col-md-4 col-sm-6 element-normal-bottom">
				<h3><i class="fa fa-search"></i> <strong>Screen Reader Compatible</strong></h3>
...
<section class="section swatch-gray">
	...
	<div class="row">
		...
		<div class="wpb_raw_code wpb_content_element wpb_raw_html">
			...
			<div class="fa-hover col-md-3 col-sm-4"> <i class="fa fa-dashboard"></i> fa-dashboard <span class="text-muted">(alias)</span>
			</div>
			<div class="fa-hover col-md-3 col-sm-4"> <i class="fa fa-desktop"></i> fa-desktop</div>
			<div class="fa-hover col-md-3 col-sm-4">ircle-o"&gt;<i class="fa fa-dot-circle-o"></i> fa-dot-circle-o</div>
			<div class="fa-hover col-md-3 col-sm-4"> <i class="fa fa-download"></i> fa-download</div>
			<div class="fa-hover col-md-3 col-sm-4"><i class="fa fa-edit"></i> fa-edit <span class="text-muted">(alias)</span>
			</div>
			...
			<div class="fa-hover col-md-3 col-sm-4"> <i class="fa fa-flash"></i> fa-flash <span class="text-muted">(alias)</span>
			</div>
			...
			<div class="fa-hover col-md-3 col-sm-4"> <i class="fa fa-gear"></i> fa-gear <span class="text-muted">(alias)</span>
			</div>
			<div class="fa-hover col-md-3 col-sm-4"> <i class="fa fa-gears"></i> fa-gears <span class="text-muted">(alias)</span>
			</div>
			...
			<div class="fa-hover col-md-3 col-sm-4"> <i class="fa fa-group"></i> fa-group <span class="text-muted">(alias)</span>
			</div>
			...
			<div class="fa-hover col-md-3 col-sm-4"> <i class="fa fa-legal"></i> fa-legal <span class="text-muted">(alias)</span>
			</div>
			...
			<div class="fa-hover col-md-3 col-sm-4"> <i class="fa fa-mail-forward"></i> fa-mail-forward <span class="text-muted">(alias)</span>
			</div>
			<div class="fa-hover col-md-3 col-sm-4"> <i class="fa fa-mail-reply"></i> fa-mail-reply <span class="text-muted">(alias)</span>
			</div>
			...
			<div class="fa-hover col-md-3 col-sm-4"> <i class="fa fa-mobile-phone"></i> fa-mobile-phone <span class="text-muted">(alias)</span>
			</div>
			...
			<div class="fa-hover col-md-3 col-sm-4">iece"&gt;<i class="fa fa-puzzle-piece"></i> fa-puzzle-piece</div>
			...
			<div class="fa-hover col-md-3 col-sm-4"> <i class="fa fa-sort-down"></i> fa-sort-down <span class="text-muted">(alias)</span>
			</div>
			...
			<div class="fa-hover col-md-3 col-sm-4"> <i class="fa fa-sort-up"></i> fa-sort-up <span class="text-muted">(alias)</span>
			</div>
			...
			<div class="fa-hover col-md-3 col-sm-4"> <i class="fa fa-star-half-empty"></i> fa-star-half-empty <span class="text-muted">(alias)</span>
			</div>
			<div class="fa-hover col-md-3 col-sm-4"><i class="fa fa-star-half-full"></i> fa-star-half-full <span class="text-muted">(alias)</span>
			</div>
			...
			<div class="fa-hover col-md-3 col-sm-4"> <i class="fa fa-toggle-down"></i> fa-toggle-down <span class="text-muted">(alias)</span>
			</div>
			<div class="fa-hover col-md-3 col-sm-4"> <i class="fa fa-toggle-left"></i> fa-toggle-left <span class="text-muted">(alias)</span>
			</div>
			<div class="fa-hover col-md-3 col-sm-4"> <i class="fa fa-toggle-right"></i> fa-toggle-right <span class="text-muted">(alias)</span>
			</div>
			<div class="fa-hover col-md-3 col-sm-4"> <i class="fa fa-toggle-up"></i> fa-toggle-up <span class="text-muted">(alias)</span>
			</div>
			...
			<div class="fa-hover col-md-3 col-sm-4"> <i class="fa fa-unsorted"></i> fa-unsorted <span class="text-muted">(alias)</span>
			</div>
			...
			<div class="fa-hover col-md-3 col-sm-4"> <i class="fa fa-warning"></i> fa-warning <span class="text-muted">(alias)</span>
			</div>
			<div class="fa-hover col-md-3 col-sm-4"> <i class="fa fa-wheelchair"></i> fa-wheelchair</div>
			<div class="fa-hover col-md-3 col-sm-4 element-tall-bottom"> <i class="fa fa-wrench"></i> fa-wrench</div>
			</div>
		</div>
		<div class="divider-wrapper" style="visibility:hidden;background-color:#FFFFFF">
			<div class="visible-xs" style="height:72px;"></div>
