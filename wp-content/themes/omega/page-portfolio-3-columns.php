...
<section class="section swatch-blue section-text-shadow section-inner-shadow">
	...
	<div class="row">
		...
		<header class="text-center  element-normal-top element-normal-bottom not-condensed os-animtion" data-os-animation="fadeIn" data-os-animation-delay=".2s" data-70-top-bottom="opacity:0" data-start="opacity:1" data-center="opacity:1">
...
<section class="section swatch-black section-text-shadow section-inner-shadow">
	<div class="background-media" style="background-image: url('<?=get_stylesheet_directory_uri()?>/assets/images/uploads/image-20-normal.jpg'); background-repeat: no-repeat; background-size: cover; background-attachment: fixed; background-position: 50% 0px;" data-start="background-position:50% 0px"
	...
	<div class="row">
		...
		<a href="http://themeforest.net/user/oxygenna" class="btn btn-link btn-lg element-short-top element-normal-bottom os-animation" target="_self" data-os-animation="fadeInUp" data-os-animation-delay="0.3s">
			buy it now
		</a>
		</div>
	</div>
