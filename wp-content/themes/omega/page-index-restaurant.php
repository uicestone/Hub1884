...
<script type="text/javascript">
	...
	navbarScrolledSwatches:
		{
			up: 'swatch-white-green',
			down: 'swatch-white-green'
		},
...
<section class="section swatch-black section-text-shadow section-inner-shadow">
	...
	<div class="row">
		...
		<header class="os-animation condensed" data-os-animation="fadeIn" data-os-animation-delay="0s">
			...
			<strong>Fresh</strong> features for starter!
			</h1>
		</header>
		<div class="divider-wrapper" style="visibility:hidden;">
			<div class="visible-xs" style="height:48px;"></div>
...
<section class="section section swatch-black section-text-shadow">
	...
	<div class="row">
		...
		<header class="text-center element-short-top element-short-bottom not-condensed os-animation" data-os-animation="fadeInLeft" data-os-animation-delay=".0s">
			...
			Awesome food! The best place for your romantic dinner night.
			</h1>
		</header>
		</div>
		<div class="col-md-2 text-center">
		<a href="contact-big-map.html" class="btn btn-primary btn-lg  element-short-top element-short-bottom os-animation" target="_self" data-os-animation="fadeInRight" data-os-animation-delay="0s">
			book now!
		</a>
		</div>
	</div>
