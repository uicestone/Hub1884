...
<section class="section swatch-black section-text-shadow section-inner-shadow">
	<div class="background-media" style="background-image: url('<?=get_stylesheet_directory_uri()?>/assets/images/uploads/home-intro.jpg'); background-repeat: no-repeat; background-size: cover; background-attachment: fixed; background-position: 50%;" data-start="background-position:50% 50%"
	...
	<div class="row">
		...
		<a href="#goto" class="scroll-to-id btn btn-link btn-lg element-no-top element-normal-bottom">
			read more
		</a>
		</div>
	</div>
...
<section id="reviews" class="section swatch-black section-text-shadow section-inner-shadow">
	...
	<div class="row">
		...
		<a href="http://themeforest.net/item/omega-multi-purpose-bootstrap-html-template/8591628" class="btn btn-primary btn-lg element-short-top element-normal-bottom os-animation" target="_blank" data-os-animation="fadeInUp" data-os-animation-delay="0s">
			Let's work together
		</a>
		</div>
	</div>
...
<section class="section swatch-blue section-text-shadow section-inner-shadow">
	...
	<div class="row">
		...
		<div class="figure element-short-top element-no-bottom os-animation image-filter-none image-filter-onhover text-center figcaption-middle" data-os-animation="fadeInUp" data-os-animation-delay="0.3s">
			<span class="figure-image">
			<img src="<?=get_stylesheet_directory_uri()?>/assets/images/uploads/image-23-devices.png" alt="">
			</span>
		</div>
		</div>
	</div>
...
<section id="two" class="section swatch-white">
	...
	<div class="row">
		...
		<a href="http://themeforest.net/item/omega-multi-purpose-bootstrap-html-template/8591628" class="btn btn-primary btn-lg  element-medium-top element-medium-bottom os-animation animated fadeInRight" target="_blank" data-os-animation="fadeInRight" data-os-animation-delay="0s ">
			get in touch
		</a>
		</div>
	</div>
